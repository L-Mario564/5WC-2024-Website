...
2. **Registrants will individually visit [https://5wc.stagec.xyz](https://5wc.stagec.xyz) and must login via osu! and Discord.**
...
12. The same FM rules apply to Qualifiers as in the Bracket Stages. These rules can be found under _Match Procedures - Freemod Rules_ < This should link to the Freemod Rules.
...
5. **HDHR** counts as two mods, but **not** as **HR** nor **HD**.
   ...
   - To clarify: Teams must have a **_lone_** **HD** (or **EZ/EZHD**) and a **_lone_** **HR** player.
